  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.calendar')
            ...
            .on('change.daterangepicker', 'select.hourselect,select.minuteselect', $.proxy(this.updateTime, this));
    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function() {
            /**
             * added by zhongzhong 2019-07-12
             */
            if($(this.container).attr("data-format")){
        ...
        buildCalendar: function (month, year, hour, minute, side) {
            ...
            var col, row;
            for (i = 0, col = 0, row = 0; i < 42; i++, col++, curDate = moment(curDate).add(12, 'hour')) {
                if (i > 0 && col % 7 === 0) {
                    col = 0;
                    row++;
                }
