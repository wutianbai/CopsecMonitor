jQuery(function(){
    ...
    var CONN4DEVICE = "连接总量[设备]",NET4DEVICE = "流量总量[设备]",CONN4TASK = "连接总量[子任务]",NET4TASK="流量总量[子任务]";
    ...
    var DURL = contextPath+"/statistics/protocol/device",NURL = contextPath+"/statistics/protocol/task";
    $.when($.ajax({
            url:DURL,
            data:{'connection':true,"type":"hour"},
            method:'POST',
            dateType:'json'}),$.ajax({
            url:DURL,
            data:{'connection':false,"type":"hour"},
            method:'POST',
            dataType:'json'
        }),$.ajax({
    ...
    $hour_1.click(function(){
        ...
        var data = {"connection":true,"type":"hour"};
    ...
    $day_1.click(function(){
        ...
        var data = {"connection":true,"type":"day"};
        var $range = $($body.find(".daterangepicker")[0]);
    ...
    $hour_3.click(function(){
        ...
        var data = {"connection":false,"type":"hour"};
    ...
    $day_3.click(function(){
        ...
        var data = {"connection":false,"type":"day"};
        var $range = $($body.find(".daterangepicker")[2]);
    ...
    $month_1.click(function(){
        ...
        var data = {"connection":true,"type":"month"};
        var $range = $($body.find(".daterangepicker")[0]);
    ...
    $month_3.click(function(){
        ...
        var data = {"connection":false,"type":"month"};
        var $range = $($body.find(".daterangepicker")[2]);
    ...
    $year_1.click(function(){
        ...
        var data = {"connection":true,"type":"year"};
        var $range = $($body.find(".daterangepicker")[0]);
    ...
    $year_3.click(function(){
        ...
        var data = {"connection":false,"type":"year"};
        var $range = $($body.find(".daterangepicker")[2]);
    ...
    $search_1.click(function(){
        ...
        var data = {"connection":true,"start":times[0],"end":times[1],"type":type};
        var $range = $($body.find(".daterangepicker")[0]);
    ...
    $search_3.click(function(){
        ...
        var times = time.split(separator);
        var type = getSearchType(times[0]);
        var data = {"connection":false,"start":times[0],"end":times[1],"type":type};
        var $range = $($body.find(".daterangepicker")[2]);
