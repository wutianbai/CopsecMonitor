    ...
    <div class="main-content">
        ...
        <div class="panel panel-color panel-success">
            ...
            <div class="panel-body">
                <div class="row">
                    <table class="table table-bordered table-model-2 table-striped" role="grid">
                        <thead>
...
<script type="text/javascript" src="<%=basePath %>static/js/copsec/system/runLog.js"></script>
</body>
</html>
