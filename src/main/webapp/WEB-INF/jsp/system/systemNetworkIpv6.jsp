    ...
    <div class="main-content">
        ...
        <div class="panel panel-color panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">接口(IPV6)</h3>
        ...
        <div class="panel panel-color panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">默认网关(IPV6)</h3>
                <div class="panel-options">
                    <a href="#" data-toggle="panel">
                        <span class="collapse-icon">&ndash;</span>
                        <span class="expand-icon">+</span>
        ...
        <div class="panel panel-color panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">DNS(IPV6)</h3>
                <div class="panel-options">
                    <a href="#" data-toggle="panel">
                        <span class="collapse-icon">&ndash;</span>
                        <span class="expand-icon">+</span>
        ...
        <div class="panel panel-color panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">管理口IP(IPV6)</h3>
                <div class="panel-options">
                    <a href="#" data-toggle="panel">
                        <span class="collapse-icon">&ndash;</span>
                        <span class="expand-icon">+</span>
        ...
        <div class="panel panel-color panel-success">
            <div class="panel-heading">
                <div class="panel-title">路由(IPV6)</div>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div role="form">
...
<script type="text/javascript" src="<%=basePath %>static/js/copsec/system/systemNetworkv6.js"></script>
