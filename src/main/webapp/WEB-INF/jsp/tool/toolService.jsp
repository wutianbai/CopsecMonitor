        ...
        <div class="panel panel-color panel-success">
            ...
            <div class="panel-body">
                    ...
                    <div role="form" class="form-inline">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="IP:PORT">
                        </div>
                        <div class="form-group">
                            <button class="btn btn-turquoise btn-single">测试</button>
                        </div>
                    </div>
                <br/>
                <div class="row">
                    <div role="form">
                        <div class="col-sm-12">
                            <textarea class="form-control" style="height:270px"></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="<%=basePath %>static/js/copsec/tool/toolService.js"></script>
