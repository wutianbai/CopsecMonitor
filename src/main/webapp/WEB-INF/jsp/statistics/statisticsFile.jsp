    ...
    <div class="main-content">
        ...
        <%--<div class="panel panel-color panel-success">
            <div class="panel-heading">
                <div class="vertical-top">
                    <div class="btn-group" >
                        <button class="btn btn-turquoise">视图切换</button>
                        <button class="btn btn-turquoise">当天统计</button>
                        <button class="btn btn-turquoise">按天统计</button>
                        <button class="btn btn-turquoise">月度统计</button>
                        <button class="btn btn-turquoise">年度统计</button>
                        &lt;%&ndash;<a href="#" target="new" class="btn btn-turquoise">导出统计</a>&ndash;%&gt;
                        <button class="btn btn-turquoise">查询</button>
                        <div class="daterange daterange-inline add-ranges" data-format="YYYY-MM-DD">
                            <i class="linecons-clock"></i><span>请选择日期</span></div>
                    </div>
                </div>
            ...
            <div class="panel-body" >
                <div class="row">
                    <div class="col-sm-11"><canvas></canvas></div>
                </div>
            </div>
        </div>--%>
        <%--<div class="panel panel-color panel-success">
            <div class="panel-heading">
                <div class="vertical-top">
                    <div class="btn-group" >
                        ...
                        <button class="btn btn-turquoise">月度统计</button>
                        <button class="btn btn-turquoise">年度统计</button>
                        &lt;%&ndash;<a class="btn btn-turquoise">导出统计</a>&ndash;%&gt;
                        <button class="btn btn-turquoise">查询</button>
                        <div class="daterange daterange-inline add-ranges" data-format="YYYY-MM-DD">
                            <i class="linecons-clock"></i><span>请选择日期</span></div>
                    </div>
...
<script type="text/javascript" src="<%=basePath %>static/js/copsec/statistics/file.js"></script>
</body>
</html>
