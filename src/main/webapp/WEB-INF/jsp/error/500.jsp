...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>${system.title} 错误页面-500</title>
    ...
    <body class="error_page" onload="startTimes();" style="text-align: center;">
    	<div style="margin-top: 200px;"><img src="<%=basePath %>image/error.png"/>
    		<span class="errorSpan">500 Error-Internal Server Error</span>
    	</div>
    	<br/>
    	<br/>
    	<br/>
	       <span style="font-size: 20px;font-weight: bold;">出现错误，请联系管理员&nbsp;<span id="seconds" style="font-size: 20px;font-weight: bold;">5</span>&nbsp;秒后将自动跳转，立即跳转请点击&nbsp;
